...
VALUES
    (1, 1, 1, 1,  '2024-01-04', '2025-01-04', 1000.00, 'activo'),
    (2, 2, 2, 2, '2024-02-04', '2025-02-04', 750.00, 'activo'),
    (3, 3, 3, 3, '2024-03-04', '2025-03-04', 1500.00, 'activo'),
    (1, 4, 1, 4, '2024-04-04', '2025-04-04', 3000.00, 'activo'),
    (2, 5, 2, 5, '2024-05-04', '2025-05-04', 6000.00, 'vencido'),
    (3, 6, 3, 6, '2024-06-04', '2025-06-04', 2000.00, 'activo'),
    (1, 7, 1, 7, '2024-07-04', '2025-07-04', 1300.00, 'activo'),
    (2, 8, 2, 8, '2024-08-04', '2025-08-04', 2300.00, 'activo'),
    (3, 9, 3, 9, '2024-09-04', '2025-09-04', 1250.00, 'activo'),
    (1, 10, 1, 10, '2024-10-04', '2025-10-04', 500.00, 'activo'),
    (2, 11, 2, 11, '2024-11-04', '2025-11-04', 100.00, 'vencido'),
    (3, 12, 3, 12, '2024-12-04', '2025-12-04', 1230.00, 'vencido'),
    (1, 13, 1, 1, '2024-01-04', '2025-01-04', 1230.00, 'activo'),
    (2, 14, 2, 2, '2024-02-04', '2025-02-04', 1000.00, 'activo'),
    (3, 15, 3, 3, '2024-03-04', '2025-03-04', 1000.00, 'activo'),
    (1, 16, 1, 4, '2024-04-04', '2025-04-04', 4000.00, 'vencido'),
    (2, 17, 2, 5, '2024-05-04', '2025-05-04', 10000.00, 'vencido'),
    (3, 18, 3, 6, '2024-06-04', '2025-06-04', 1500.00, 'vencido'),
    (1, 19, 1, 7, '2024-07-04', '2025-07-04', 7000.00, 'vencido'),
    (2, 20, 2, 8, '2024-08-04', '2025-08-04', 12000.00, 'vencido'),
    (3, 21, 3, 9, '2024-09-04', '2025-09-04', 1400.00, 'activo'),
    (1, 22, 1, 10, '2024-10-04', '2025-10-04', 1550.00, 'activo'),
    (2, 23, 2, 11, '2024-11-04', '2025-11-04', 1020.00, 'activo'),
    (3, 24, 3, 12, '2024-12-04', '2025-12-04', 1000.00, 'activo'),
    (4, 1, 4, 1,  '2024-01-04', '2025-01-04', 2000.00, 'activo'),
    (5, 2, 5, 2, '2024-02-04', '2025-02-04', 850.00, 'activo'),
    (6, 3, 6, 3, '2024-03-04', '2025-03-04', 2500.00, 'activo'),
    (7, 4, 7, 4, '2024-04-04', '2025-04-04', 1000.00, 'activo'),
    (8, 5, 8, 5, '2024-05-04', '2025-05-04', 4000.00, 'vencido'),
    (9, 6, 9, 6, '2024-06-04', '2025-06-04', 6000.00, 'vencido'),
    (10, 7, 10, 7, '2024-07-04', '2025-07-04', 2300.00, 'activo'),
    (11, 8, 11, 8, '2024-08-04', '2025-08-04', 3300.00, 'vencido'),
    (12, 9, 12, 9, '2024-09-04', '2025-09-04', 4250.00, 'activo'),

    (4, 25, 4, 1,  '2024-01-04', '2025-01-04', 10000.00, 'activo'),
    (6, 26, 6, 2, '2024-02-04', '2025-02-04', 1250.00, 'activo'),
    (3, 27, 3, 3, '2024-03-04', '2025-03-04', 6500.00, 'activo'),
    (1, 28, 1, 4, '2024-04-04', '2025-04-04', 2000.00, 'activo'),
    (7, 29, 7, 5, '2024-05-04', '2025-05-04', 4000.00, 'vencido'),
    (3, 30, 3, 6, '2024-06-04', '2025-06-04', 1000.00, 'activo'),
    (1, 31, 1, 7, '2024-07-04', '2025-07-04', 4300.00, 'activo'),
    (8, 32, 8, 8, '2024-08-04', '2025-08-04', 5300.00, 'activo'),
    (3, 33, 3, 9, '2024-09-04', '2025-09-04', 3250.00, 'activo'),
    (1, 34, 1, 10, '2024-10-04', '2025-10-04', 1500.00, 'activo'),
    (2, 35, 2, 11, '2024-11-04', '2025-11-04', 800.00, 'vencido'),
    (3, 36, 3, 12, '2024-12-04', '2025-12-04', 4230.00, 'vencido'),
    (9, 37, 9, 1, '2024-01-04', '2025-01-04', 6230.00, 'activo'),
    (2, 38, 2, 2, '2024-02-04', '2025-02-04', 5000.00, 'activo'),
    (3, 39, 3, 3, '2024-03-04', '2025-03-04', 4000.00, 'activo'),
    (1, 40, 1, 4, '2024-04-04', '2025-04-04', 6000.00, 'vencido'),
    (2, 41, 2, 5, '2024-05-04', '2025-05-04', 8000.00, 'vencido'),
    (3, 42, 3, 6, '2024-06-04', '2025-06-04', 6500.00, 'vencido'),
    (10, 43, 10, 7, '2024-07-04', '2025-07-04', 5000.00, 'vencido'),
    (2, 44, 2, 8, '2024-08-04', '2025-08-04', 32000.00, 'vencido'),
    (3, 45, 3, 9, '2024-09-04', '2025-09-04', 1400.00, 'activo'),
    (7, 46, 7, 10, '2024-10-04', '2025-10-04', 11550.00, 'activo'),
    (2, 47, 2, 11, '2024-11-04', '2025-11-04', 4020.00, 'activo'),
    (3, 48, 3, 12, '2024-12-04', '2025-12-04', 6000.00, 'activo'),
    (4, 25, 4, 1,  '2024-01-04', '2025-01-04', 8000.00, 'activo'),
    (12, 26, 12, 2, '2024-02-04', '2025-02-04', 1850.00, 'activo'),
    (6, 27, 6, 3, '2024-03-04', '2025-03-04', 3500.00, 'activo'),
    (7, 28, 7, 4, '2024-04-04', '2025-04-04', 5000.00, 'activo'),
    (8, 29, 8, 5, '2024-05-04', '2025-05-04', 6000.00, 'vencido'),
    (9, 30, 9, 6, '2024-06-04', '2025-06-04', 5000.00, 'vencido'),
    (10, 31, 10, 7, '2024-07-04', '2025-07-04', 4300.00, 'activo'),
    (11, 32, 11, 8, '2024-08-04', '2025-08-04', 8300.00, 'vencido'),
    (12, 33, 12, 9, '2024-09-04', '2025-09-04', 1250.00, 'activo'),
